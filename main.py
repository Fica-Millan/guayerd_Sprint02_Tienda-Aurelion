...
opcion = st.sidebar.radio(
    ...
    ["Información general", "Estadísticas iniciales", "EDA Automatizado", "EDA Diagnóstico", "Ver documentación"]
)
...
st.markdown(
    ...
    <div style='text-align: center; font-size: 15px; color: gray;'>
        <p><b>Sprint 02 – Fundamentos de Inteligencia Artificial</b><br>
